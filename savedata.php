    ...
    <html lang="ja">
        ...
        <body>
            ...
            <div class="big-div">
                <div class="div-info">
                    <div class="divdiv">
                        <p class="p-info">科名：</p><p class="p-view">メディアアート科</p>
                    </div>
                    <div class="divdiv">
                        <p class="p-info">氏名：</p><p class="p-view"  >情報花子</p>
                    </div>
                    <div class="divdiv">
                        <p class="p-info">番号：</p><p class="p-view">○○番</p>
                    </div>
                    <div class="divdiv">
                        <p class="p-info">応募件数：</p><p class="p-view">○○件目</p>
                    </div>
                    <div class="divdiv">
                    ...
                    <div class="divdiv">
                        <p class="p-info">提出書類：</p><p class="p-view">履歴書</p>
                    </div>
                    <div class="divdiv">
                ...
                <div class="div-detail">
                    <div class="test">
                        <div>
                            <p>一次：</p><p>日時(○○月 ○○日：○○時 ○○分～○○時 ○○分)</p><p>適性検査(専門分野)</p>
                        </div>
                        <div>
