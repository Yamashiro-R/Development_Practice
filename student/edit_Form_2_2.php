...
<!DOCTYPE html>
    <html lang="ja">
        ...
        <body>
            <div class="return">
                <a href="edit_Form_2_1.php"><img src="../images/innu.jpeg"></a>
            </div>
            <div id="main_title"> 
            ...
            <div class="big-div">   
                <form action="edit_Form_2_2.php" method="post" name="test">
                    <div class="div-info">
                    ...
                    <div class="button">
                       <input type="submit"  class="btn_item" name="cancel" value="キャンセル" alt="キャンセル">
                        ...
                        <input type="submit" class="btn_item step3" name="Input_3" value="三次なし" alt="step_3へ" disabled>
                    </div>
                    <div class="button">
