                ...
                <form action="#">
                    <div class="div-info">
                        <div class="divdiv_col_1 divdiv input_width"> 
                            <p class="p-info p-width_1"><label for="test_day">三次試験日：</label></p>
                            <input type="date" class="input-view" name="third_date" id="test_day">
                        </div>     
                        <div class="divdiv"> 
                        ...
                        <div class="divdiv"> 
                            <p class="p-info p-width_2"><label for="end_time">終了日時：</p>
                    ...
                    <div class="button">
                        ...
                        <input type="button" onclick="location.href='Input_Form_3.php'" class="btn_item" value="ステップ3へ→" alt="ステップ3へ→">
                    </div>
                </form>
            </div>
