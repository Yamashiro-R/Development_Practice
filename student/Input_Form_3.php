...
<?php 
    ...
    //戻るボタン用のURLを設定する。
    $return_URL;
    if( !empty( $_SESSION['Input_3'] ) ){
        //$_SESSION['Input_3']がある時
        switch($_SESSION['Input_3']){
            case 1:
                $return_URL = "Input_Form_2_1.php";
                break;
            case 2:
                $return_URL = "Input_Form_2_2.php";
                break;
            default:
                $return_URL = "Input_Form_2_3.php";
